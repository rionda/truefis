...
\begin{fact}\label{fact:maxfreq}
	Given \fabio{\st{this definition} a collection $\mathcal{C}$ of itemsets and} a dataset $\Ds$, the maximum
	...
	\end{equation}
	where \fabio{$\range(\mathcal{C})$} is as in Def.~\ref{def:rangeset}, and $d$ is an
