...
\fabio{\st{The work of }\citet{RiondatoU14} \st{on the
VC-dimension of frequent itemsets and association rules inspired us, although we
deal with a different problem, different goals, and use different tools.} The techniques used in
\citet{RiondatoU14} are directly related to our work, although we deal with a 
different problem, different goals, and use different tools.} In the
