...
def main():
    ...
    # Only do another phase if asked to
    if phases == 3:
    ...
    else: # only perform two phases. This is the alternative of "if phases == 3"
        sample_res = freq_itemsets_2_dict
        epsilon_3 = -1.0; # doing this for the logs
